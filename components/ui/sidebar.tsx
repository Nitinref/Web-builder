...
export const DesktopSidebar = ({
  ...
  return (
    <motion.div
      className={cn(
        // ✅ NO bg- classes here — background comes from style prop in Sidebar.tsx
...
export const MobileSidebar = ({
  ...
  return (
    <>
      <div
        className="h-10 px-4 py-4 flex flex-row md:hidden items-center justify-between w-full"
      ...
      >
        ...
        <AnimatePresence>
          {open && (
            ...
            >
              <div
                className="absolute right-10 top-10 z-50 text-neutral-400"
                onClick={() => setOpen(!open)}
              >
                <IconX />
              </div>
  ...
  return (
    ...
    >
      ...
      <motion.span
        ...
        // ✅ NO text-neutral classes — color comes from parent
